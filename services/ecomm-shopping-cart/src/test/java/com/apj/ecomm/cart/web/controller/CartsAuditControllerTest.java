...
@WebMvcTest(controllers = CartsAuditController.class,
		properties = { "eureka.client.enabled=false", "spring.cloud.config.enabled=false" })
@AutoConfigureMockMvc(addFilters = false)
@ExtendWith(MockitoExtension.class)
class CartsAuditControllerTest {

	@Value("${api.version}${admin.path}${carts.path}")
	private String uri;
	...
	@MockitoBean
	private ICartsAuditService service;
