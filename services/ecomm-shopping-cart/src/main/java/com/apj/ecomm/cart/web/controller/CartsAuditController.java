...
import com.apj.ecomm.cart.domain.ICartsAuditService;
...
@Tag(name = "Shopping Carts Audit API", description = "Endpoints for viewing shopping carts")
@RestController
@RequestMapping("${api.version}${admin.path}${carts.path}")
...
public class CartsAuditController {

	private final ICartsAuditService service;
