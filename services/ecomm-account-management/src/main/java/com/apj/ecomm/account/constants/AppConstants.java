...
public final class AppConstants {
	...
	public static final String MSG_CONFLICT = "Details provided is already registered";

	public static final String MSG_UNAUTHORIZED = "Credentials provided is incorrect";
